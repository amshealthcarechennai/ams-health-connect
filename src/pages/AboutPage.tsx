            ...
            <div className="animate-slide-in-left">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-heading text-2xl font-bold text-foreground">10+</div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground text-sm">Hospital Partners</div>
                  </div>
                </div>
              </div>
            </div>

            <div className="bg-card rounded-2xl shadow-xl border p-8 animate-slide-in-right">
              <h3 className="font-heading font-semibold text-xl mb-6 text-foreground">Why Choose Us</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {clients.map((client) => (
              <div
                key={client}
                className="flex items-center gap-3 bg-card rounded-lg border p-4 hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300"
              >
